...
import { PurchaseCoordinatorForecatingChartService } from './purchase-coordinator-forecating-chart.service';
...
@Component({
  selector: 'app-purchase-coordinator-forecating-chart',
  templateUrl: './purchase-coordinator-forecating-chart.component.html',
  styleUrls: ['./purchase-coordinator-forecating-chart.component.css']
})
export class PurchaseCoordinatorForecatingChartComponent implements OnInit{
  ...
  constructor(private purchasecoordinatorforecastingchartservice : PurchaseCoordinatorForecatingChartService) {}

  async getData(){
    const jsonData = await this.purchasecoordinatorforecastingchartservice.getData(this.selectedCategory, this.selectedStatus);
